  ...
  if (subParam) {
    ...
    return (
      <div className="min-h-screen bg-[#f9fafb] text-black">
        {/* Full-width premium subcategory hero section */}
        <section className="relative min-h-[60vh] flex items-center bg-white text-black py-16 overflow-hidden border-b border-neutral-200">
          ...
          <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden bg-white">
            {subcategoryData?.heroBgVideo ? (
              <video
                ...
                muted
                playsInline
                className="object-cover absolute inset-0 w-full h-full opacity-[0.18] filter grayscale"
              />
            ) : (
              <Image
              ...
              <div className="lg:col-span-7 space-y-6 text-left">
                <AnimatedSection direction="up" delay={0.05}>
                  <button
                    ...
                    className="inline-flex items-center gap-2 text-[9px] font-extrabold uppercase tracking-widest text-neutral-500 hover:text-black border border-neutral-200 hover:border-black rounded-lg px-3.5 py-2 transition-all duration-300 cursor-pointer bg-white/85 backdrop-blur-sm"
                  >
                ...
                <StaggerContainer delay={0.25} className="flex flex-wrap gap-x-6 gap-y-3 pt-6 border-t border-neutral-200">
                  {[
                    ...
                    <StaggerItem key={i} className="flex items-center space-x-2">
                      ...
                      <span className="text-[11px] font-bold text-neutral-800 tracking-tight">{item}</span>
                    </StaggerItem>
                  ))}
                </StaggerContainer>
              </div>
