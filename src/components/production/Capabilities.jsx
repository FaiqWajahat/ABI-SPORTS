...
const CAPABILITIES = [
  ...
  { id: 1, label: 'Stitching', title: 'Industrial Stitching & Assembly', description: 'Our stitching halls house high-speed Yamato 4-needle flatlock machines, Juki overlock sewing units, Brother lockstitch stations, and Kansai Special multi-needle machines for low-profile, durable seam joins.', specs: ['Yamato 4-needle flatlock seamers', 'Juki 5-thread industrial overlockers', 'Brother computerized lockstitch units', 'Kansai Special elastic waist machines'] },
